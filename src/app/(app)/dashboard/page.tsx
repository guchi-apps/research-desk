...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const [visible, lastCollectedAt, latestRunId, overview, triageCounts] = await Promise.all([listIndustryInformation({ weekOffset, business, source, importance, keyword, analysis, hideExcluded }), getLastCollectedAt(), getLatestCollectionRunId(), getAnalysisOverview(), countTriage()]);
